...
def run(gpuCount, globalBatch, amplificationLimit=2.0, dataParallelBaseline=False, netBw=2.66E5, spatialSplit=False, simResultFilename=None, simOnly=False, use_be=False):
    global cs
...
if __name__ == "__main__":
    ...
    print(len(sys.argv))
    # if len(sys.argv) == 3:
    run(4,512, dataParallelBaseline=True)
    # elif len(sys.argv) >= 4:
